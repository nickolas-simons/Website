...
![CS415 Final Project](/assets/JunkDrawer/cs415_final.gif)

- VR two-handed weapon proof of concept from early 2020, inspired by the title Boneworks

![VR Weapon Test](/assets/JunkDrawer/vr_weapontest.gif)

- VR Table Top RPG from 2020, my introduction to custom shaders

![DnD Shader Test](/assets/JunkDrawer/dnd_preview.gif)
